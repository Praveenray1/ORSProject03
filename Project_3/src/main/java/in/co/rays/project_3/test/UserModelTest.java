...
public class UserModelTest {
	...
	private static void findByLoginTest() throws ApplicationException {
		...
		UserDTO dto = model.findByLogin("26praveenray@gmail.com");
	...
	public static void addTest() throws Exception {
		...
		dto.setFirstName("Praveen");
		dto.setLastName("Ray");
		dto.setDob(sdf.parse("26-01-2000"));
		dto.setConfirmPassword("Praveen@123");
		dto.setPassword("Praveen@123");
		dto.setLogin("26praveenray@gmail.com");
		dto.setGender("male");
		dto.setUnSuccessfullLogin(1);
		...
		dto.setRoleId(1);
		dto.setMobileNo("9630703265");
		dto.setRegisteredIP("26praveenray@gmail.com");
		dto.setLoginIP("26praveenray@gmail.com");
