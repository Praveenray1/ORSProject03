...
public abstract class BaseCtl extends HttpServlet {
	...
	/**
	 * Save message key constant
	 */
	public static final String OP_SAVE = "Save";
	/**
	 * Cancel message key constant
	 */
	public static final String OP_CANCEL = "Cancel";
	/**
	 * Delete message key constant
	 */
	public static final String OP_DELETE = "Delete";
	/**
	 * Reset message key constant
	 */
	public static final String OP_RESET = "Reset";
	/**
	 * List message key constant
	 */
	public static final String OP_LIST = "List";
	/**
	 * Search message key constant
	 */
	...
	/**
	 * Next message key constant
	 */
	public static final String OP_NEXT = "Next";
	/**
	 * Previous message key constant
	 */
	public static final String OP_PREVIOUS = "Previous";
	/**
	 * New message key constant
	 */
	public static final String OP_NEW = "New";
	/**
	 * Go message key constant
	 */
	public static final String OP_GO = "Go";
	/**
	 * Back message key constant
	 */
	public static final String OP_BACK = "Back";
	/**
	 * Update message key constant
	 */
	public static final String OP_UPDATE = "Update";
	/**
	 * Logout message key constant
	 */
	public static final String OP_LOG_OUT = "Logout";
	/**
	 * My Profile message key constant
	 */
